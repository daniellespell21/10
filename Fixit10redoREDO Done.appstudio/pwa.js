...
const cacheName = 'Fixit10redo_Done-2020-11-25 15:25:00.211695'; // unique value, generated each deploy
  ...
  e.waitUntil(
    caches.keys().then((keyList) => {
      ...
      return Promise.all(keyList.map((key) => {
        ...
        if (cacheName.indexOf(key) === -1  && key.substr(0, 'Fixit10redo_Done'.length) === 'Fixit10redo_Done') {
